...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
	...
	<script type="text/javascript">
		...
		function removeAndInsertItem() {
			...
			//항목 삭제(자바스크립트 배열은 자바의 리스트와 비슷합니다.)
		...
		function filterItem() {
			...
			//return이 true가 되는것만 item을 모아서 새로운 배열 생성 //5번 반복//===타입과 값이 같다
	...
	<div class="card">
  		...
  		<div class="card-body">
  				...
  				<p><button onclick="sortItem()" class="btn btn-info btn-sm">분류</button></p>
  		</div>
